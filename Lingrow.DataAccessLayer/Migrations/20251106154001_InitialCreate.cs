    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "https://www.ibm.com/content/dam/adobe-cms/instana/media_logo/AWS-EC2.png/_jcr_content/renditions/cq5dam.web.1280.1280.png", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new DateOnly(2004, 6, 21), null, "Nguyen Minh A", 'M', "Active", null },
                    { 2L, "https://tse3.mm.bing.net/th/id/OIP.JMspq1z3Vm2m00ioNzUtEgHaHa?cb=12&rs=1&pid=ImgDetMain&o=7&rm=3", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new DateOnly(2004, 6, 21), null, "Nguyen Minh B", 'M', "Active", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 0, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "winhtuan.dev@gmail.com", false, null, null, null, new byte[] { 116, 63, 45, 102, 193, 171, 8, 42, 68, 233, 146, 96, 202, 43, 251, 179, 206, 71, 1, 251, 58, 48, 141, 11, 241, 199, 15, 85, 158, 160, 57, 116 }, new byte[] { 229, 111, 20, 109, 231, 252, 93, 204, 64, 123, 57, 235, 210, 227, 231, 88 }, "admin", false, "minha" },
                    { 2L, 0, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "winhtuan@gmail.com", false, null, null, null, new byte[] { 116, 63, 45, 102, 193, 171, 8, 42, 68, 233, 146, 96, 202, 43, 251, 179, 206, 71, 1, 251, 58, 48, 141, 11, 241, 199, 15, 85, 158, 160, 57, 116 }, new byte[] { 229, 111, 20, 109, 231, 252, 93, 204, 64, 123, 57, 235, 210, 227, 231, 88 }, "user", false, "minhb" }
                });
