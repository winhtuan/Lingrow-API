...
namespace Lingrow.DataAccessLayer.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ref_id = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    ref_type = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    email_confirmed_at = table.Column<DateTime>(
                        type: "timestamptz",
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "user_activity");

            migrationBuilder.DropTable(name: "user_login_data");

            migrationBuilder.DropTable(name: "user_account");
        }
    }
}
